document.addEventListener('DOMContentLoaded', initSlider('slider2'));
    ...
    function initSlider(id) {
        ...
        const bulletsEl = document.querySelector('#' + id + ' .sliderBullets');
        ...
        function initArrows() {
            const arrowBackEl = document.querySelector('#' + id + ' .arrowBack');
            const arrowForwardEl = document.querySelector('#' + id + ' .arrowForward');
